...
def main():
    parser = argparse.ArgumentParser(description="Song Research Tool")
    ...
    try:
        ...
        print("\n🎵 Song Research Tool is running!")
        print(f"* Backend API: http://localhost:{port}")
        print("* Frontend UI: http://localhost:3000 (start with: cd frontend && npm run dev)")
